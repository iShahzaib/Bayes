...
var displayNodeValuesOnNode = function(d) {	
	d3.select("#display-node-values").html("");

	var nodeValsDiv = d3.select("#display-node-values")
						// .append("div")
						// .attr("class", "table-responsive div-table")
						// .attr("id", "edit-div-tbl");

	var nodeInfo = nodeValsDiv.append("table")
					 .attr("class", "table table-bayes node-show-tbl")
					//  .append("tbody")
