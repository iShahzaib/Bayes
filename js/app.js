...
var refresh = function(){
	...
	circleGroup.append("rect")
    		   .attr({"x": "-5", "y": "-18", "width": rectWidth, "height": rectHeight})
    		   .call(function(d) {
    		   	  d.each(function(e) {
    		   	  	createCPT(e);
    		   	  })
	...
	circleGroup.append("foreignObject")
			   .attr({"x": "0", "y": "10", "width": rectWidth-10, "height": rectHeight-10, "id": "display-node-values"})
			//    .append("body")
